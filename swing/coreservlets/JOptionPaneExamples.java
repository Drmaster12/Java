...
/** Example to let user interactively create any of the main
 *  JOptionPanes, specifying the various options and choosing
 *  the desired looks. 
 *  <p>
...
// TODO: Need to update it to add Nimbus LAF as an option!

public class JOptionPaneExamples extends JFrame 
  ...
  private JLabeledTextField titleField, messageField, 
                            selectionValuesField, 
                            buttonLabelsField;
  private JCheckBox ignoreSelectionValuesBox;
  private ButtonGroup messageTypeButtonGroup, 
  ...
  public JOptionPaneExamples() {
    ...
    content.add(new RadioButtonPanel("Dialog type:",
                dialogTypeButtons, dialogTypeButtonGroup));
    ...
    content.add(new RadioButtonPanel("Option Pane Type:", 
                messageTypeButtons, messageTypeButtonGroup));

    lookAndFeelBoxes = 
      new JCheckBox[] { new JCheckBox("Native", true), 
                        new JCheckBox("Java (Metal)"),
			               new JCheckBox("Motif") };
    content.add(new CheckBoxPanel("Looks to use:", 
                                  lookAndFeelBoxes));

    titleField = new JLabeledTextField("Title:", 
                            "Title to appear at top of border");
    content.add(titleField);
    messageField = new JLabeledTextField("Message:", 
                      "Message to appear inside of dialog box");
    ...
    RadioButtonPanel buttonLabelPanel =
      new RadioButtonPanel("Button Labels:", buttonTypeButtons, 
			                   buttonTypeButtonGroup);
    DisableListener.addEnabler(dialogTypeButtons[1], 
                               buttonLabelPanel);
    content.add(buttonLabelPanel);

    selectionValuesField = 
      new JLabeledTextField(
            "Choices to present to user (separate by spaces):",
			   "Choice1 Choice2 Choice3 Choice4");
    content.add(selectionValuesField);

    ignoreSelectionValuesBox = new JCheckBox(
      "Ignore predefined choices and supply textfield to user");
    ...
    buttonLabelsField = new JLabeledTextField(
                         "Button labels for \"Option\" dialog:",
			                "Button1 Button2 Button3");
    DisableListener.addEnabler(dialogTypeButtons[3], 
                               buttonLabelsField); 
  ...
  private int getAssociatedType(AbstractButton[] buttons, 
                                int[] types) {
...
class CheckBoxPanel extends JPanel {
  public CheckBoxPanel(String labelString, JCheckBox[]
                       checkBoxes) {
